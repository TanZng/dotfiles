# Generated by Powerlevel10k configuration wizard on 2024-07-18 at 13:50 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_VCS_GIT_ICON='\uf113'
  ...
  # typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awsume|awless|cdk|terraform|pulumi|terragrunt'
